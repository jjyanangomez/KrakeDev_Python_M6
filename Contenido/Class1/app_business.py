...
class AppBuisness:
    def __init__(self,root):
        self.root= root
        self.laptops=[]
        self.imagnes=["C:\\Users\\H P\\Desktop\\JuanJo\\Curso_KrakeDev\\Practicas\\Modulo_6_Python\\Contenido\\Class1\\img\\1.png",
    ...
    def agregar_laptop(self):
        nueva_laptop=Laptop_Business(self.marca.get(),self.procesador.get(),self.memoria.get(),self.almacenamiento.get(),self.duracion.get(),self.precio.get())
